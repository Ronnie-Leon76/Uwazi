...
var ShambaAssistantTokenSale = artifacts.require("ShambaAssistantTokenSale");

contract("ShambaAssistantTokenSale", function (accounts) {
  var tokenInstance;
  ...
  it("initializes the contract with the correct values", function () {
    return ShambaAssistantTokenSale.deployed()
  ...
  it("facilitates token buying", function () {
    return ShambaAssistantToken.deployed()
      .then(function (instance) {
